            ...
            if(s.length() > 0) {
                switch(selectedPosition) {
                    ...
                    case 3:
                        ...
                        if(isCurrentCode) {
                            Toast.makeText(GetCodeActivity.this, "Все верно", Toast.LENGTH_SHORT).show();
                            Intent create_password = new Intent(GetCodeActivity.this, CreatePassword.class);
                            startActivity(create_password);
                        } else {
                            Toast.makeText(GetCodeActivity.this, "Неверно введен код", Toast.LENGTH_SHORT).show();
    ...
    private boolean checkCode() {
        ...
        call.enqueue(new Callback<UserToken>() {
            ...
            public void onFailure(@NonNull Call<UserToken> call, @NonNull Throwable t) {
                Toast.makeText(GetCodeActivity.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
